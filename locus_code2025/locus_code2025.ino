// this is a code for black line in white surface
...
#define MaxSpeed 255 //170
#define BaseSpeed 255 //170
int lastError = 0;
...
void maze()
{
  ...
  while (1) //path
  {
    ...
    {
      follow_segment();
      forward(motor1, motor2, 60); //60    // After reaching a intercetion follow the shortest path turn
      delay(60); 
      // forward(motor1, motor2, 60);
      // delay(100);
      brake(motor1, motor2);
